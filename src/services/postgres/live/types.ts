...
export interface _TimescaledbCatalogChunkRewrite {
  chunkRelid: string;
  newRelid: string;
}
...
export interface _TimescaledbCatalogContinuousAggsMaterializationRanges {
  greatestModifiedValue: Int8;
  lowestModifiedValue: Int8;
  materializationId: number | null;
}
...
export interface DB {
  ...
  "_TimescaledbCatalog.chunkRewrite": _TimescaledbCatalogChunkRewrite;
  ...
  "_TimescaledbCatalog.continuousAggsMaterializationRanges": _TimescaledbCatalogContinuousAggsMaterializationRanges;
